...
const AddTest = () => {
  const [formData, setFormData] = useState({
    ...
    price: '',
    duration: '',
    status: 'Active', // Capitalized to match backend validation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.createTest(formattedData);
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2 col-span-2">
                ...
                <Select
                  value={formData.sample_types[0] || ''}
                  onValueChange={val => setFormData({ ...formData, sample_types: [val] })}
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2 col-span-2">
                ...
                <div className="overflow-x-auto">
                        ...
                        <tr key={idx}>
                          ...
                          <td className="border px-2 py-1">
                            <Input
                              ...
                              onChange={e => handleParameterChange(idx, 'normal', e.target.value)}
                            />
                          </td>
                  ...
                  <div className="mt-2">
                    <Button type="button" size="sm" onClick={addParameterRow}>
                      + Add Parameter
                    </Button>
                  </div>
                </div>
